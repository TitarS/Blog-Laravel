            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="top-comment"><!--top comment-->
                        <img src="{{ $user->getAvatar() }}" class="pull-left img-circle" alt="" width="124px" height="109px">
                        <h4>{{ $user->name }}</h4>
                        <p>{!! $user->text !!}</p>
                    </div><!--top comment end-->
                    @endif
                    ...
                    <div class="bottom-comment"><!--bottom comment-->
                        ...
                        <div class="comment-img">
                            <img class="img-circle" src="{{ $comment->author->getAvatar() }}" alt="" width="110" height="75">
                        </div>
